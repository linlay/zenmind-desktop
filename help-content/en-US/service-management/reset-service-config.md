Each service program directory includes a `.env.example` configuration template. The active configuration is stored under the Desktop data directory's `config` layer. To reset a configuration:
