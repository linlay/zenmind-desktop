Create Codex pet row `running-right` for `cutej`: exactly 8 full-body frames in one horizontal strip on flat pure green #00FF00.

Use the attached canonical base for identity and the layout guide only for spacing. Same pet in every frame: CuteJ mascot reference: teal-blue spiky hair, blue-and-white headset, white jacket with blue trim, blue pants, white boots, energetic friendly chibi 3D toy style; no readable text or logos.. Preserve silhouette, face, palette, material, proportions, markings, and props.
