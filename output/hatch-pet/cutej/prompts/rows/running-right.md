Create one horizontal animation strip for Codex pet `cutej`, state `running-right`.
...
Identity: same pet in every frame: CuteJ mascot reference: teal-blue spiky hair, blue-and-white headset, white jacket with blue trim, blue pants, white boots, energetic friendly chibi 3D toy style; no readable text or logos.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
