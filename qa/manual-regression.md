...
- 桌宠概览在浅色/深色及 280/376/424px 宽度下检查近白/深色面板、标题与摘要层级、Markdown 摘要清理和 +N 更多；回复输入独占一行，与操作按钮相隔 12px，发送按钮下方有留白，列表滚动时卡片不得压缩并与下一条消息重叠。
