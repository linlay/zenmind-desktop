...
- macOS / Windows 分别在中英文和浅深色下进入 Agents：依次显示平台（智能体、技能中心、连接器中心、Registries、归档对话）、云端（市场、产物管理、分享管理）与帮助组（帮助）；禁用市场或帮助时隐藏对应空组，分组标题不可点击，菜单选中态、页面跳转和返回应用正常。
...
- macOS / Windows 中能力侧栏标题为“平台”“云端”，云端按市场、产物管理、分享管理排列；产物管理同样支持“在导航栏显示”及混合拖拽。
