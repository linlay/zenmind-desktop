...
const images={};
for(const mode of ['light','dark']) for(const name of Object.keys(kittyPaths).filter(name => !['attach','refresh'].includes(name))) {
