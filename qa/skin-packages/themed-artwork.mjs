...
const motifs = { 'gold-saints': bow, tahiti: turtle, 'walnut-song': joint };
...
export function themedGeometry(key, name, original) {
 ...
 const detail = key==='gold-saints'?p('M8 2l4 2 4-2'):key==='tahiti'?p('M7 22l5-3 5 3'):p('M2 7V2h5m10 20h5v-5');
