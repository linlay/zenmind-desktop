...
export async function createUpdateManifest(input) {
  ...
  const { productId, version, releaseNotes = {}, artifacts, publishedAt = new Date().toISOString(), schemaVersion = 2 } = input;
  ...
  return { schemaVersion: 2, productId, version, publishedAt, releaseNotes, artifacts: output };
}
