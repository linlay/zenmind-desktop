...
import { ActiveAssistantRun, AgentPlatformImageCompletionRequest, AgentPlatformImageCompletionResult, ImageGenerateOutcome, MAX_GENERATED_IMAGE_BYTES, PlatformAdminRegistryListResponse, PlatformAgentSummary, PlatformChatSummary, buildZenmiImageGenerateMessage, createChatId, createRunId, mapChatSummary, mapHistoryChat, nowEpochMillis, observeImageGenerateEvent, readErrorText, readResponseBytesWithLimit, readString, unwrapApiResponse, validGeneratedImageRelativePath } from "./bridge.shared";
