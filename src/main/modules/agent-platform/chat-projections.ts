import { type PlatformChatSummary, type PlatformChatSearchResponse, type PlatformRunSummary } from "./bridge-contracts";
import {
  type AssistantChatSummary,
  type AssistantHistoryChatItem,
  type AssistantChatSearchResult,
  type AssistantChatSearchResponse,
  type AssistantChatMessage
} from "../../../shared/contracts";
import {
  validatePresentPlatformTimes,
  validateAwaitingPayloadTimes,
  readRequiredPlatformTimestamp,
  isPendingAwaitingPayload,
  readAwaitingMode,
  readAwaitingPayloadMode,
  readOptionalPlatformTimestamp
} from "./platform-event-normalizer";
import { readString, readNumber, createRunId, createMessageId } from "./bridge-values";
