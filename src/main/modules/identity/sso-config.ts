import type {
  ...
  DesktopSsoBrowserSessionConfig,
  AccessTokenCookieConfig,
  DesktopSsoClaimsConfig,
  DesktopSsoUserInfoConfig,
  DesktopSsoAvatarCacheConfig,
  DesktopSsoWebSessionClearCookieConfig,
  DesktopSsoWebSessionExchangeConfig,
  DesktopSsoConfigLoadResult
} from "./sso-model";
import {
  DEFAULT_OIDC_CONFIG,
  ...
  OIDC_CONFIG_STRING_FIELDS,
  OIDC_CONFIG_URL_FIELDS
} from "./sso-defaults";
import {
  isGoogleOidcConfig,
  getRecordString,
  ...
  shouldUsePkceByDefault,
  isServerBrokerAuthMode,
  isPublicPkceOidcConfig,
  isConfigEnabled
} from "./sso-config-values";
import { PRODUCT_NAME } from "../../../shared/brand";
import { t } from "../../support/i18n/main-i18n";
import type { App } from "electron";
import { resolveDesktopSsoConfigPath } from "./sso-paths";
