...
import { listCatalogOnlyMarketItems } from "./catalog-only-market";
import { installAgentMarketItem, uninstallAgentMarketItem } from "./agent-market";
import {
...
export async function uninstallMarketItem(
  ...
  const result = type === "plugin"
    ...
    : type === "pet"
      ...
      : type === "website-app"
        ? await uninstallWebsiteAppMarketItem(app, itemId, options)
