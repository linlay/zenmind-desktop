...
import { StartupPreparationOptions, backgroundStartupPreparationTasks, isHostManagedService, needsBundledAssetRefresh } from "./index.part-1";
import { getServiceState, getStartupResponsiveServiceStateReadOptions, getStartupServiceStateReadOptions } from "./index.part-2";
import { getPreparedStartupStartOptions, shouldReinitializeMissingCoreServiceConfig, yieldStartupScheduler } from "./index.part-3";
import { StartupPipelineOptions, StartupPreparationServiceResult, StartupServiceResult, ensurePreStartRequirements, getResourcePluginServiceIdsToRestore, initializeService, initializeServiceInternal, installBuiltinService, installedBuiltinNeedsStartupRepair, isResourcePluginServiceId, stopService } from "./index.part-4";
