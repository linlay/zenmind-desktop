...
import { RegisteredSurface, RegisteredWebviewSurfaceTarget, SurfaceRegistrationValidation, activeRegistrationTab, describeMainChatRoute, mainChatSurfaceRegistrationTransitionAllowed, preserveInactiveMainChatIdentity, registeredSurfaceIdentitiesConflict, sanitizeSurfaceDiagnosticId } from "./browser-surface-registry.shared";
