...
import { getPluginsRoot, getProgramsRoot } from "./user-paths";
import { buildServiceEnv } from "./services/manager/command-env";
import { terminateProcessTree } from "./services/manager/process-cleanup";
import { windowsPowerShellPath } from "./services/manager/command-runner";
