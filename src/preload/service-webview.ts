...
window.addEventListener(AGENT_WEBCLIENT_PLATFORM_FRAME_PORT_OPEN_EVENT, (event) => {
  ipcRenderer.send(
    AGENT_WEBCLIENT_PLATFORM_FRAME_PORT_OPEN_CHANNEL,
...
window.addEventListener(AGENT_WEBCLIENT_PLATFORM_FRAME_PORT_SEND_EVENT, (event) => {
  ipcRenderer.send(
    AGENT_WEBCLIENT_PLATFORM_FRAME_PORT_SEND_CHANNEL,
    (event as CustomEvent<Record<string, unknown>>).detail,
  );
...
window.addEventListener(AGENT_WEBCLIENT_PLATFORM_FRAME_PORT_CLOSE_EVENT, (event) => {
  ipcRenderer.send(
    AGENT_WEBCLIENT_PLATFORM_FRAME_PORT_CLOSE_CHANNEL,
    (event as CustomEvent<Record<string, unknown>>).detail,
  );
