	...
	return (
		<div className="code-assistant-context-bar" ref={menuRef}>
			<div className="code-assistant-context-main">
				...
				<div className="code-assistant-mode-group" role="tablist" aria-label="代码助手访问模式">
					<button
						type="button"
						role="tab"
					...
					>
						<span className="code-assistant-mode-dot is-global" aria-hidden="true" />
					...
					>
						<span className="code-assistant-mode-dot is-folder" aria-hidden="true" />
