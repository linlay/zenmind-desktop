...
import { resolveHostCodeAssistantRuntime } from "@/shared/utils/host";
import {
  AWAITING_EXPIRED_MESSAGE,
...
export const ComposerArea: React.FC = () => {
  ...
  const codeAssistantChatBlocked = Boolean(
    codeAssistantRuntime &&
      !codeAssistantRuntime.ready &&
      isCodeAssistantWorker(currentWorker, codeAssistantRuntime.agentKey),
  );
