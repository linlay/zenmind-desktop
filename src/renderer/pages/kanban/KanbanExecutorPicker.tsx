  ...
  return <div className="kanban-field">
    <div className="kanban-field-head">
      ...
      <div className="kanban-executor-actions">
        ...
        <button type="button" className="kanban-executor-more" disabled={disabled || !value} onClick={() => onChange("")}>
          {t("common.clear")}
        </button>
      </div>
    </div>
    <div id={listId} className="kanban-executor-cards" role="group" aria-labelledby={labelId}>
      ...
      {expanded && search && visibleAgents.length === 0 && <small>{t("kanban.form.executorNoResults")}</small>}
