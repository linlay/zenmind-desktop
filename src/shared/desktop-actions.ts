...
export const DESKTOP_ACTION_DEFINITIONS = [
  ...
  { name: "desktop.webapp.init", kind: "execute", category: "web", confirmation: "none", description: "Initialize a Manifest v2 WebApp inside the trusted source Run workspace. Agent Platform only. Args: { projectPath, key, label, target? }; projectPath is workspace-relative." },
