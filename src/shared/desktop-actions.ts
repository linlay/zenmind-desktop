...
export const DESKTOP_ACTION_DEFINITIONS = [
  ...
  { name: "desktop.embeddedWeb.listSurfaces", kind: "read", category: "embeddedWeb", description: "List embedded website surfaces." },
  { name: "desktop.embeddedWeb.getActiveSurface", kind: "read", category: "embeddedWeb", description: "Read the active embedded website surface." },
  { name: "desktop.embeddedWeb.activateSurface", kind: "execute", category: "embeddedWeb", description: "Activate an embedded website surface." },
  { name: "desktop.embeddedWeb.getPageContext", kind: "read", category: "embeddedWeb", description: "Read embedded website page context." },
  { name: "desktop.embeddedWeb.readPageData", kind: "read", category: "embeddedWeb", description: "Read structured page data from an embedded website." },
  { name: "desktop.embeddedWeb.extractStructured", kind: "read", category: "embeddedWeb", description: "Extract structured content from an embedded website." },
  { name: "desktop.embeddedWeb.interactElement", kind: "execute", category: "embeddedWeb", description: "Interact with an element inside an embedded website." },
  { name: "desktop.embeddedWeb.executeScript", kind: "execute", category: "embeddedWeb", description: "Execute JavaScript inside an embedded website." },
  { name: "desktop.embeddedWeb.navigate", kind: "execute", category: "embeddedWeb", description: "Navigate an embedded website tab to a URL." },
  { name: "desktop.embeddedWeb.reload", kind: "execute", category: "embeddedWeb", description: "Reload an embedded website tab." },
  { name: "desktop.embeddedWeb.goBack", kind: "execute", category: "embeddedWeb", description: "Go back in an embedded website tab." },
  { name: "desktop.embeddedWeb.openTab", kind: "execute", category: "embeddedWeb", description: "Open a new embedded website tab." },
