...
export const DESKTOP_ACTION_DEFINITIONS = [
  ...
  { name: "desktop.web.website.add", kind: "execute", category: "web", description: "Add a Desktop website entry." },
  { name: "desktop.web.website.update", kind: "execute", category: "web", description: "Update a Desktop website entry." },
  { name: "desktop.web.website.remove", kind: "execute", category: "web", description: "Remove a Desktop website entry." },
