...
export const DESKTOP_ACTION_DEFINITIONS = [
  ...
  { name: "desktop.web.listSurfaces", kind: "read", category: "web", description: "List live webpage Surfaces within the trusted Chat/Run scope. Each page has a surfaceId and containerId." },
  { name: "desktop.web.getSurfaceState", kind: "read", category: "web", description: "Read one authorized webpage. Args: { surfaceId }. Returns { surface }." },
  { name: "desktop.web.interactElement", kind: "execute", category: "web", description: "Interact with an authorized webpage element. Args: { surfaceId, selector, action, value? }." },
  { name: "desktop.web.executeScript", kind: "execute", category: "web", description: "Execute JavaScript in an authorized webpage. Args: { surfaceId, script }." },
  { name: "desktop.web.exportArtifact", kind: "execute", category: "web", description: "Export an artifact from an authorized WebApp Surface directly to Downloads. Args: { surfaceId, format: png|html|project|pdf }. Returns an absolute filePath; payload bytes never enter the agent context." },
  { name: "desktop.web.activateSurface", kind: "execute", category: "web", description: "Show an authorized webpage. Args: { surfaceId }." },
  { name: "desktop.web.navigate", kind: "execute", category: "web", description: "Navigate one authorized webpage. Args: { surfaceId, url }." },
  { name: "desktop.web.reload", kind: "execute", category: "web", description: "Reload one authorized webpage in place. Args: { surfaceId }." },
  { name: "desktop.web.refreshSurface", kind: "execute", category: "web", description: "Reload one authorized webpage in place, preserving its Surface identity. Args: { surfaceId }." },
  { name: "desktop.web.goBack", kind: "execute", category: "web", description: "Navigate one authorized webpage back. Args: { surfaceId }." },
  { name: "desktop.web.openTab", kind: "execute", category: "web", description: "Open a webpage alongside the selected Surface in its owning Container. Args: { surfaceId, url }. Returns the new surfaceId. WebApp is single-page." },
  { name: "desktop.web.closeTab", kind: "execute", category: "web", description: "Close one authorized webpage through its host lifecycle. Args: { surfaceId }. Returns { success }." },
  { name: "desktop.web.switchTab", kind: "execute", category: "web", description: "Select the exact authorized webpage. Args: { surfaceId }." },
  ...
  { name: "desktop.workpanel.openWeb", kind: "execute", category: "workpanel", description: "Open or activate an HTTP(S) webpage in the trusted Chat WorkPanel. Default for ordinary Chat requests to open a URL. Args: { url }. Returns { workspace, surfaceId, containerId, status }." },
  ...
  { name: "desktop.webapp.package.init", kind: "execute", category: "web", confirmation: "none", description: "Initialize a Manifest v2 WebApp inside the trusted source Run workspace. Agent Platform only. Args: { projectPath, key, label, target? }; projectPath is workspace-relative." },
