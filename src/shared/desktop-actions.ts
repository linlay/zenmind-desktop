...
export const DESKTOP_ACTION_DEFINITIONS = [
  ...
  { name: "desktop.workpanel.openTab", kind: "execute", category: "workpanel", description: "Open or activate a canonical WorkPanel tab for the trusted source chat. Args: { descriptor }." },
  { name: "desktop.workpanel.openWeb", kind: "execute", category: "workpanel", description: "Open or activate an HTTP(S) WebView item for the trusted source chat. Args: { url }." },
  { name: "desktop.workpanel.refreshWeb", kind: "execute", category: "workpanel", description: "Reload and activate an existing HTTP(S) WebView item for the trusted source chat. Args: { url }." },
  { name: "desktop.workpanel.activateTab", kind: "execute", category: "workpanel", description: "Activate a WorkPanel tab for the trusted source chat. Args: { tabId }." },
  { name: "desktop.workpanel.closeTab", kind: "execute", category: "workpanel", description: "Close a closable WorkPanel tab for the trusted source chat. Args: { tabId }." },
