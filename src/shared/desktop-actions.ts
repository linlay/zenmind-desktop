...
export const DESKTOP_ACTION_DEFINITIONS = [
  ...
  { name: "desktop.workpanel.openItem", kind: "execute", category: "workpanel", description: "Open or activate a canonical WorkPanel item for the trusted source chat." },
  { name: "desktop.workpanel.activateItem", kind: "execute", category: "workpanel", description: "Activate a WorkPanel item for the trusted source chat." },
  { name: "desktop.workpanel.closeItem", kind: "execute", category: "workpanel", description: "Close a closable WorkPanel item for the trusted source chat." },
  { name: "desktop.workpanel.closeWorkspace", kind: "execute", category: "workpanel", description: "Close the trusted source chat WorkPanel workspace." },
  { name: "desktop.chatWorkPanel.getState", kind: "read", category: "chatWorkPanel", description: "Read the calling chat's Work Panel and CDP target state. Args: none." },
  { name: "desktop.chatWorkPanel.open", kind: "execute", category: "chatWorkPanel", description: "Open the calling chat's Work Panel and ensure it has one blank tab. Args: none." },
  { name: "desktop.chatWorkPanel.close", kind: "execute", category: "chatWorkPanel", description: "Destroy the calling chat's Work Panel and all of its tabs. Args: none." },
  { name: "desktop.chatWorkPanel.openTab", kind: "execute", category: "chatWorkPanel", description: "Open and activate a Work Panel tab for the calling chat. Args: { url, title? }; url accepts http, https, or about:blank." },
  { name: "desktop.chatWorkPanel.activateTab", kind: "execute", category: "chatWorkPanel", description: "Activate a Work Panel tab owned by the calling chat. Args: { tabId }." },
  { name: "desktop.chatWorkPanel.closeTab", kind: "execute", category: "chatWorkPanel", description: "Close a Work Panel tab owned by the calling chat; closing the last tab destroys the panel. Args: { tabId }." },
  ...
  { name: "desktop.webapp.updatePreferences", kind: "execute", category: "web", description: "Update a local WebApp label or Desktop open-mode preference. Args: { webappId|id, patch: { label?, openMode? } }." },
