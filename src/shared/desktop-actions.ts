...
export const DESKTOP_ACTION_DEFINITIONS = [
  ...
  { name: "desktop.web.website.add", kind: "execute", category: "web", description: "Add one Desktop website entry. Args: { input: { label, url, copilotAgentKey? } } or top-level label/url; url is required. Do not send items/name-only batches.", outputSchema: WEBSITE_ITEMS_OUTPUT_SCHEMA },
