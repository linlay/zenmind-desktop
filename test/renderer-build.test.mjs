...
test("Kanban cards use a three-section hierarchy with granular status and stable actions", () => {
  ...
  assert.match(kanbanPage, /const granularStatusLabel = issue\.statusName\?\.trim\(\) \|\| ""/);
  assert.match(kanbanPage, /label: granularStatusLabel,[\s\S]{0,120}tone: granularStatusTone/);
  ...
  assert.match(kanbanPage, /className="issue-card-footer-signals"/);
  assert.match(kanbanPage, /className="issue-card-footer-signal"/);
  ...
  assert.match(kanbanPage, /className="issue-card-footer-signal" title=\{automationLabel\}/);
  assert.match(kanbanPage, /const shouldShowAssignee = display\.assignee[\s\S]{0,180}canEditKanbanIssueBody\(issue\)/);
  ...
  assert.match(kanbanStyles, /\.issue-card-title-block\s*\{[\s\S]{0,400}font-weight:\s*600;/);
  assert.match(kanbanStyles, /\.issue-card-description\s*\{[\s\S]{0,220}-webkit-line-clamp:\s*1;/);
  ...
  assert.match(kanbanStyles, /\.issue-card-footer-signals\s*\{/);
  assert.match(kanbanStyles, /\.issue-card-footer-signal\s*\{/);
...
test("Kanban route exposes native desktop api and page styles", () => {
  ...
  assert.match(kanbanStyles, /\.issue-card\s*\{[\s\S]{0,360}min-height:\s*126px;[\s\S]{0,360}height:\s*auto;/);
  ...
  assert.match(kanbanStyles, /\.issue-card-title-block\s*\{[\s\S]{0,320}font-weight:\s*600;/);
  ...
  assert.match(kanbanStyles, /\.issue-card-foot\s*\{[\s\S]{0,220}grid-template-columns:\s*minmax\(72px, auto\) minmax\(0, 1fr\) minmax\(48px, auto\);/);
  assert.match(kanbanStyles, /\.issue-card\.is-running-state \.issue-card-status-dot\s*\{[\s\S]{0,120}animation:\s*kanban-running-status-dot/);
