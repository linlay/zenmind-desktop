...
test("desktop pet visual states stay local to renderer priority", () => {
  ...
  assert.match(petAssetScript, /"dragging-moving"/);
  ...
  assert.match(petAssetScript, /"dragging-moving":\s*\{\s*row:\s*1,\s*column:\s*2\s*\}/);
  assert.match(petAssetScript, /"dragging-moving":\s*\{\s*row:\s*7,\s*column:\s*2\s*\}/);
