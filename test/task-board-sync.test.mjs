...
test("task board sync maps assistant terminal events to task board run state", () => {
  ...
  assert.equal(resolveTaskBoardStatusFromAssistantEvent({ type: "run.completed" }), "completed");
  assert.equal(resolveTaskBoardStatusFromAssistantEvent({ type: "completed" }), "completed");
  assert.equal(resolveTaskBoardStatusFromAssistantEvent({ status: "succeeded" }), "completed");
  assert.equal(resolveTaskBoardStatusFromAssistantEvent({ status: "success" }), "completed");
  assert.equal(resolveTaskBoardRunStateFromAssistantEvent({ type: "run.complete" }), "completed");
  assert.equal(resolveTaskBoardRunStateFromAssistantEvent({ type: "run.completed" }), "completed");
  assert.equal(resolveTaskBoardRunStateFromAssistantEvent({ type: "completed" }), "completed");
  assert.equal(resolveTaskBoardRunStateFromAssistantEvent({ status: "succeeded" }), "completed");
  assert.equal(resolveTaskBoardRunStateFromAssistantEvent({ status: "success" }), "completed");
